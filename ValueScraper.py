...
for empresa in tablaBase.find_all("a"):
    ...
    hypEmpresa = ("=HIPERVINCULO(\"" + carpeta + nombreEmpresa + ".gif\";" + "\"" + nombreEmpresa + "\")")
...
# siguiente fila ya que la tabla sigue sumando las id:
            if(numCelda > 7+i):
                ...
                row = (hypEmpresa,nombreEmpresa,fecha,cierre,maximo,minimo)
...
# posterior análisis
df.columns = ["Imagen","Empresa","Fecha","Cierre","Maximo","Minimo"]
